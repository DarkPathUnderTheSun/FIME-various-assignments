...
<form action="" method="post" name="Agregar">
  ...
  <form action="formulario-contacto.php" method="post">
				<input name="item_name" type="text" placeholder="Nombre de herramienta" maxlength="80" pattern="([A-z0-9À-ž\s]){3,}" required autofocus/>
        ...
        <input name="modelo" type="text" placeholder="Modelo" required />
				...
				<button id="Submit" name="Submit" value="Agregar" class="btn">Agregar</button>
