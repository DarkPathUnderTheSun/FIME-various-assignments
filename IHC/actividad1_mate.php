<html>
    ...
    <body>
        <nav class="menu matematicas">
            ...
            <label><i class="fas fa-calculator"></i>&nbsp;Pensamiento Matematico</label>
        </nav>
        <div class="contenedor matematicas">
           ...
           <div class="center-flex">
                ...
                <form method="post">
                    <input class= "zubmitMat" type="submit" name="test" id="test" value="Entregar" /><br/>
                </form>
            </div>
        </div>
    </body>
...
if (isset($_POST['test'])) {
  ...
  $query_string = "update actividades set mat_act_1 = 100 where username = '{$uname}'";
